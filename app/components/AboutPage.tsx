...
const AboutPage = () => {
  return (
    <div className="flex flex-col items-center w-full h-screen space-y-5 mb-0 md:mb-0">
      <h1 className="text-2xl font-semibold tracking-[5px] text-center my-16 border-8 border-white w-48 mx-auto uppercase px-6 py-3 galaxyS9:my-6">
        About
      </h1>
      <motion.div
      ...
      >
        <main className="grid grid-cols-1 md:grid-cols-3 gap-10 w-full px-16 md:max-w-[1400px]">
          <div className="my-4 md:pt-52">
            <h2 className=" text-[#FDDA0D] md:text-2xl font-semibold mb-4 uppercase tracking-widest galaxyS9:text-center galaxyS9:text-lg">
              Development
            </h2>
            <p className=" tracking-widest md:text-md md:text-left galaxyS9:text-xs galaxyS9:text-center">
