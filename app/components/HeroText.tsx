...
const HeroText = () => {
  ...
  return (
    ...
    >
      <h1 className="text-center md:max-w-[440px] text-5xl md:text-7xl mr-12 font-bold galaxyS9:max-w-[200px] galaxyS9:text-4xl blackBerryPlayBook:text-6xl blackBerryPlayBook:max-w-[330px]">
        <span>{text}</span>
